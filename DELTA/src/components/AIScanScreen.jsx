import { ArrowLeft, ImagePlus, Smartphone, Images, Sparkles } from 'lucide-react';
...
export default function AIScanScreen({ onBack }) {
  return (
    <div className="flex flex-col gap-8 px-3 pt-4 pb-16">
      ...
      {/* 업로드 박스 */}
      <button
        className="bg-[#FFFFFF] rounded-[40px] flex flex-col items-center justify-center py-14 gap-2 w-80 h-70 self-center active:scale-[0.98] transition-transform"
        style={{
          backgroundImage: "url(\"data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='40' ry='40' stroke='%232ECC71' stroke-width='8' stroke-dasharray='10%2c 12' stroke-linecap='auto'/%3e%3c/svg%3e\")",
        }}
      >
