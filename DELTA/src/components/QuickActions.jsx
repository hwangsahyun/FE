...
export default function QuickActions({ onScan, onDirectInput }) {
  return (
    <div className="grid grid-cols-2 gap-3" style={{ width: 353, padding: '5px' }}>
      {/* 직접 입력 */}
      <button onClick={onDirectInput} className="flex flex-col items-center justify-center gap-2 rounded-3xl bg-[#2ECC71]/100 border border-[#2ECC71]/100 shadow-md active:scale-95 transition-transform" style={{ paddingTop: '5px', paddingBottom: '5px' }}>
